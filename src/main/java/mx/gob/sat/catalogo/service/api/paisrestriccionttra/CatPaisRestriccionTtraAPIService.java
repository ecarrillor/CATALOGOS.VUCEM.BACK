...
/**
 * <b>Class:</b> CatPaisRestriccionTtraAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de paises restriccion TTRA.</p>
 *
 ...
 */
public interface CatPaisRestriccionTtraAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatPaisRestriccionTtraResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idPaisRestriccionTtra Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatPaisRestriccionTtraResponse> findById(Integer idPaisRestriccionTtra);
     ...
     */
    BaseResponse<CatPaisRestriccionTtraResponse> crear(CatPaisRestriccionTtraRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idPaisRestriccionTtra Identificador del registro a actualizar.
     * @param request               Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatPaisRestriccionTtraResponse> actualizar(Integer idPaisRestriccionTtra, CatPaisRestriccionTtraRequest request);
}
