...
/**
 * <b>Class:</b> CatTipoDocumentoAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de TipoDocumento.</p>
 *
 ...
 */
public interface CatTipoDocumentoAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatTipoDocumentoResponse>> listar(
     ...
     */
    BaseResponse<CatTipoDocumentoResponse> findById(Short idTipoDocumento);
     ...
     */
    BaseResponse<CatTipoDocumentoResponse> crear(CatTipoDocumentoRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idTipoDocumento Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatTipoDocumentoResponse> actualizar(Short idTipoDocumento, CatTipoDocumentoRequest request);
}
