...
/**
 * <b>Class:</b> CatPatenteAduanalAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de PatenteAduanal.</p>
 *
 ...
 */
public interface CatPatenteAduanalAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatPatenteAduanalResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param cvePatenteAduanal Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatPatenteAduanalResponse> findById(String cvePatenteAduanal);
     ...
     */
    BaseResponse<CatPatenteAduanalResponse> crear(CatPatenteAduanalRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param cvePatenteAduanal Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatPatenteAduanalResponse> actualizar(String cvePatenteAduanal, CatPatenteAduanalRequest request);
}
