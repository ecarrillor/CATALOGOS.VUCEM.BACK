...
/**
 * <b>Class:</b> CatLocalidadAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de Localidad.</p>
 *
 ...
 */
public interface CatLocalidadAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatLocalidadResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param cveLocalidad Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatLocalidadResponse> findById(String cveLocalidad);
     ...
     */
    BaseResponse<CatLocalidadResponse> crear(CatLocalidadRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param cveLocalidad Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatLocalidadResponse> actualizar(String cveLocalidad, CatLocalidadRequest request);
}
