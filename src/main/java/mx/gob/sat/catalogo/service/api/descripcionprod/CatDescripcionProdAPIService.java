...
/**
 * <b>Class:</b> CatDescripcionProdAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de DescripcionProd.</p>
 *
 ...
 */
public interface CatDescripcionProdAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatDescripcionProdResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idDescripcionProd Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatDescripcionProdResponse> findById(Integer idDescripcionProd);
     ...
     */
    BaseResponse<CatDescripcionProdResponse> crear(CatDescripcionProdRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idDescripcionProd Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatDescripcionProdResponse> actualizar(Integer idDescripcionProd, CatDescripcionProdRequest request);
}
