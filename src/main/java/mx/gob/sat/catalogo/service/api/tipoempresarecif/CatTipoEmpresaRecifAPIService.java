...
/**
 * <b>Class:</b> CatTipoEmpresaRecifAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de TipoEmpresaRecif.</p>
 *
 ...
 */
public interface CatTipoEmpresaRecifAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatTipoEmpresaRecifResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param cveTipoEmpresaRecif Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatTipoEmpresaRecifResponse> findById(String cveTipoEmpresaRecif);
     ...
     */
    BaseResponse<CatTipoEmpresaRecifResponse> crear(CatTipoEmpresaRecifRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param cveTipoEmpresaRecif Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatTipoEmpresaRecifResponse> actualizar(String cveTipoEmpresaRecif, CatTipoEmpresaRecifRequest request);
}
