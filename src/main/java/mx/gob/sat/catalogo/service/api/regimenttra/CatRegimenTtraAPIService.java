...
/**
 * <b>Class:</b> CatRegimenTtraAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de regimenes ttra.</p>
 *
 ...
 */
public interface CatRegimenTtraAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatRegimenTtraResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idRegimenTtra Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatRegimenTtraResponse> findById(Short idRegimenTtra);
     ...
     */
    BaseResponse<CatRegimenTtraResponse> crear(CatRegimenTtraRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idRegimenTtra Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatRegimenTtraResponse> actualizar(Short idRegimenTtra, CatRegimenTtraRequest request);
}
