...
/**
 * <b>Class:</b> CatCatalogoHAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de CatalogoH.</p>
 *
 ...
 */
public interface CatCatalogoHAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatCatalogoHResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param cveCatalogoH Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatCatalogoHResponse> findById(String cveCatalogoH);
     ...
     */
    BaseResponse<CatCatalogoHResponse> crear(CatCatalogoHRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param cveCatalogoH Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatCatalogoHResponse> actualizar(String cveCatalogoH, CatCatalogoHRequest request);
}
