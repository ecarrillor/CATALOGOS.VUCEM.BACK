...
/**
 * <b>Class:</b> CatCasAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de Cas.</p>
 *
 ...
 */
public interface CatCasAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatCasResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idCas Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatCasResponse> findById(Short idCas);
     ...
     */
    BaseResponse<CatCasResponse> crear(CatCasRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idCas Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatCasResponse> actualizar(Short idCas, CatCasRequest request);
}
