...
/**
 * <b>Class:</b> CatFraccionAladiAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de FraccionAladi.</p>
 *
 ...
 */
public interface CatFraccionAladiAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatFraccionAladiResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idFraccionAladi Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatFraccionAladiResponse> findById(Long idFraccionAladi);
     ...
     */
    BaseResponse<CatFraccionAladiResponse> crear(CatFraccionAladiRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idFraccionAladi Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatFraccionAladiResponse> actualizar(Long idFraccionAladi, CatFraccionAladiRequest request);
}
