...
/**
 * <b>Class:</b> CatUnidadAdministrativaAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de UnidadAdministrativa.</p>
 *
 ...
 */
public interface CatUnidadAdministrativaAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatUnidadAdministrativaResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param cveUnidadAdministrativa Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatUnidadAdministrativaResponse> findById(String cveUnidadAdministrativa);
     ...
     */
    BaseResponse<CatUnidadAdministrativaResponse> crear(CatUnidadAdministrativaRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param cveUnidadAdministrativa Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatUnidadAdministrativaResponse> actualizar(String cveUnidadAdministrativa, CatUnidadAdministrativaRequest request);
}
