...
/**
 * <b>Class:</b> CatEmpresaRecifAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de empresas RECIF.</p>
 *
 ...
 */
public interface CatEmpresaRecifAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatEmpresaRecifResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su clave RECIF.
     *
     * @param recif Clave RECIF del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatEmpresaRecifResponse> findById(String recif);
     ...
     */
    BaseResponse<CatEmpresaRecifResponse> crear(CatEmpresaRecifRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param recif   Clave RECIF del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatEmpresaRecifResponse> actualizar(String recif, CatEmpresaRecifRequest request);
}
