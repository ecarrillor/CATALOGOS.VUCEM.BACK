...
/**
 * <b>Class:</b> CatEspecieAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de Especie.</p>
 *
 ...
 */
public interface CatEspecieAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatEspecieResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idEspecie Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatEspecieResponse> findById(Integer idEspecie);
     ...
     */
    BaseResponse<CatEspecieResponse> crear(CatEspecieRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idEspecie Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatEspecieResponse> actualizar(Integer idEspecie, CatEspecieRequest request);
}
