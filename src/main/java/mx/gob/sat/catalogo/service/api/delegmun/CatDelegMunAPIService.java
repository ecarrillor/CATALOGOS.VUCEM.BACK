...
/**
 * <b>Class:</b> CatDelegMunAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de DelegMun.</p>
 *
 ...
 */
public interface CatDelegMunAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatDelegMunResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param cveDelegMun Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatDelegMunResponse> findById(String cveDelegMun);
     ...
     */
    BaseResponse<CatDelegMunResponse> crear(CatDelegMunRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param cveDelegMun Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatDelegMunResponse> actualizar(String cveDelegMun, CatDelegMunRequest request);
}
