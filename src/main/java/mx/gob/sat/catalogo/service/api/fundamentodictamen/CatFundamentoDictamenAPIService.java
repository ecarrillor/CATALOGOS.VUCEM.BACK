...
/**
 * <b>Class:</b> CatFundamentoDictamenAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de FundamentoDictamen.</p>
 *
 ...
 */
public interface CatFundamentoDictamenAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatFundamentoDictamenResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idFundamentoDictamen Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatFundamentoDictamenResponse> findById(Long idFundamentoDictamen);
     ...
     */
    BaseResponse<CatFundamentoDictamenResponse> crear(CatFundamentoDictamenRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idFundamentoDictamen Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatFundamentoDictamenResponse> actualizar(Long idFundamentoDictamen, CatFundamentoDictamenRequest request);
}
