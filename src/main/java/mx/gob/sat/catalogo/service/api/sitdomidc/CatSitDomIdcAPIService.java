...
/**
 * <b>Class:</b> CatSitDomIdcAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de SitDomIdc.</p>
 *
 ...
 */
public interface CatSitDomIdcAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatSitDomIdcResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idSitDomIdc Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatSitDomIdcResponse> findById(Long idSitDomIdc);
     ...
     */
    BaseResponse<CatSitDomIdcResponse> crear(CatSitDomIdcRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idSitDomIdc Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatSitDomIdcResponse> actualizar(Long idSitDomIdc, CatSitDomIdcRequest request);
}
