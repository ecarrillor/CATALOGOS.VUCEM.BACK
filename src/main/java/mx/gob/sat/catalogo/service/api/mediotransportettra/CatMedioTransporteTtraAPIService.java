...
/**
 * <b>Class:</b> CatMedioTransporteTtraAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de medios de transporte ttra.</p>
 *
 ...
 */
public interface CatMedioTransporteTtraAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatMedioTransporteTtraResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idMedioTransporteTtra Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatMedioTransporteTtraResponse> findById(Integer idMedioTransporteTtra);
     ...
     */
    BaseResponse<CatMedioTransporteTtraResponse> crear(CatMedioTransporteTtraRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idMedioTransporteTtra Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatMedioTransporteTtraResponse> actualizar(Integer idMedioTransporteTtra, CatMedioTransporteTtraRequest request);
}
