...
/**
 * <b>Class:</b> CatTipoProductoTtraAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de tipos de producto ttra.</p>
 *
 ...
 */
public interface CatTipoProductoTtraAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatTipoProductoTtraResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idTipoProductoTtra Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatTipoProductoTtraResponse> findById(Short idTipoProductoTtra);
     ...
     */
    BaseResponse<CatTipoProductoTtraResponse> crear(CatTipoProductoTtraRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idTipoProductoTtra Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatTipoProductoTtraResponse> actualizar(Short idTipoProductoTtra, CatTipoProductoTtraRequest request);
}
