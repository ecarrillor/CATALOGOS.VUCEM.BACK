...
/**
 * <b>Class:</b> CatEquivMonedaAPIService.java <br>
 * <b>Description:</b>
 * <p>Contrato del servicio API para el catalogo de EquivMoneda.</p>
 *
 ...
 */
public interface CatEquivMonedaAPIService {
     ...
     */
    BaseResponse<PaginaResponse<CatEquivMonedaResponse>> listar(
            int pagina, int tamano, String busqueda, String sortBy, String sortDir);

    /**
     * Busca un registro por su identificador.
     *
     * @param idEquivMoneda Identificador del registro.
     * @return Registro encontrado envuelto en BaseResponse.
     */
    BaseResponse<CatEquivMonedaResponse> findById(Integer idEquivMoneda);
     ...
     */
    BaseResponse<CatEquivMonedaResponse> crear(CatEquivMonedaRequest request);

    /**
     * Actualiza los campos no nulos de un registro existente.
     *
     * @param idEquivMoneda Identificador del registro a actualizar.
     * @param request Datos a actualizar.
     * @return Registro actualizado envuelto en BaseResponse.
     */
    BaseResponse<CatEquivMonedaResponse> actualizar(Integer idEquivMoneda, CatEquivMonedaRequest request);
}
