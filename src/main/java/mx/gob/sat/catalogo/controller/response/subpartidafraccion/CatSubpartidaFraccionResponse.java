package mx.gob.sat.catalogo.controller.response.subpartidafraccion;
...
/**
 * Response para el catalogo de subpartida fraccion.
 *
...
@Getter
@Setter
public class CatSubpartidaFraccionResponse {
