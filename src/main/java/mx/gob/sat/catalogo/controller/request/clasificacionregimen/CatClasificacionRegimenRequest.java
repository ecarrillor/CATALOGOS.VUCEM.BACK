package mx.gob.sat.catalogo.controller.request.clasificacionregimen;
...
/**
 * Request para el catalogo de clasificacion de regimen.
 *
...
@Getter
@Setter
public class CatClasificacionRegimenRequest {
