...
public class CatalogPaths extends ConstPath{
    ...
    public static final String COMBO_PAISES_PTA                     = "/cat_pais_tratado_ac/paises";
    public static final String COMBO_TRATADOS_PTA                   = "/cat_pais_tratado_ac/tratados";
    ...
    public static final String LIST_TIPO_CERTIFICADO = "cat_combinacion_sg/tipo_certificado/{id}";
    public static final String LIST_UPDATE_TIPO_CERTIFICADO = "cat_combinacion_sg/tipo_certificado/{id}/{catalogo}";
    ...
    public static final String LAST_FRACCION_TTRA   = "/cat_fraccion_ttra/ultimo_fraccion_ttra";
    ...
    /* last ID — catálogos dependientes de TipoTramite */
    public static final String LAST_ADUANA_CLASIF_PROD        = "/cat_aduana_clasif/ultimo_aduana_clasif";
    public static final String LAST_CAS_FRACCION_TTRA         = "/cat_cas_fraccion_ttra/ultimo_cas_fraccion_ttra";
    public static final String LAST_CAT_CAS                   = "/cat_cas/ultimo_cas";
    public static final String LAST_CLASIF_PRODUCTO           = "/cat_clasif_producto/ultimo_clasif_producto";
