...
public class CatFraccionTtraController {
    ...
    @GetMapping(CatalogPaths.LAST_FRACCION_TTRA)
    public ResponseEntity<ClasifProductoTraDTO> lastFraccionTtra() {
        return ResponseEntity.ok(service.lastFraccionTtra());
    }
}
