...
public interface ICatDocumentoTramiteService {
    ...
    CatDocumentoTramiteDTO findById(Short idTipoDoc, Integer idTipoTramite);

    CatDocumentoTramiteDTO create(CatDocumentoTramiteDTO dto);

    CatDocumentoTramiteDTO update(Short idTipoDoc, Integer idTipoTramite, CatDocumentoTramiteDTO dto);
}
