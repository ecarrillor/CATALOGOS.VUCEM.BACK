...
public class CatDescripcionProdServiceImpl implements ICatDescripcionProdService {
    ...
    private static final Map<String, String> ALLOWED_SORT_COLUMNS = Map.of(
            "idDescripcionProd", "d.id",
            "descripcionProducto", "d.descripcionProducto",
            "nombreTramite", "t.descModalidad"
    );

    @Override
    public PageResponseDTO<CatDescripcionProdResponseDTO> listAll(String search, Long idTipoTramite, String sortBy, String sortDir, Pageable pageable) {
        Boolean activo = null;
        String texto = null;
        ...
        Page<CatDescripcionProdResponseDTO> page = repository.search(texto, activo, idTipoTramite, pageableWithSort);
