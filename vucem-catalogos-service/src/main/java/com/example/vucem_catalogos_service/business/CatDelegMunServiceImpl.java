...
public class CatDelegMunServiceImpl implements ICatDelegMunService {
    ...
    @Override
    public PageResponseDTO<CatDelegMunDTO> list(String search, String sortBy, String sortDir, Pageable pageable) {
        Boolean activo = null;
        String texto = null;
        ...
        Page<CatDelegMunDTO> page = catDelegMunRepository.search(texto, activo, sortedPageable);
